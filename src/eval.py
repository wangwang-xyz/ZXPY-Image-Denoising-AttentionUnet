...
if __name__ == '__main__':
    ...
    for idx in range(0,10):
        input_path = os.path.join(data_path, "noisy{}.dng".format(idx))
        output_path = os.path.join(save_path, "denoise{}.dng".format(idx))
        ...
        # inference
        raw_data_expand_c_normal = raw_data_expand_c_normal.to(device)
        result_data = model(raw_data_expand_c_normal)
